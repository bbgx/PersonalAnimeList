...
namespace AnimeList.Migrations
{
    ...
    [Migration("20240127231159_UndoLastMigrationChangingCharactersToCharactersInVoiceActorClass")]
    partial class UndoLastMigrationChangingCharactersToCharactersInVoiceActorClass
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimeList.Models.CharacterModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AnimeList.Models.CharacterModel+VoiceActor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("VoiceActorImage")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CharacterModelVoiceActor", b =>
                {
                    b.Property<int>("CharacterId")
                        .HasColumnType("integer");

                    b.Property<int>("VoiceActorsId")
                        .HasColumnType("integer");

                    b.HasKey("CharacterId", "VoiceActorsId");

                    b.HasIndex("VoiceActorsId");

                    b.ToTable("CharacterModelVoiceActor");
                });

            modelBuilder.Entity("AnimeList.Models.CharacterModel", b =>
                {
                    b.HasOne("AnimeICollection.Models.AnimeModel.AnimeModel", "Anime")
                        .WithMany()
            ...
            modelBuilder.Entity("CharacterModelVoiceActor", b =>
                {
                    b.HasOne("AnimeList.Models.CharacterModel", null)
                        .WithMany()
                        .HasForeignKey("CharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AnimeList.Models.CharacterModel+VoiceActor", null)
                        .WithMany()
